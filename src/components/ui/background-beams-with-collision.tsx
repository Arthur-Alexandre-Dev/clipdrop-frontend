...
// Não usar a tipagem genérica de React.forwardRef para evitar erros de tipo
    ...
    >
      ...
      {spans.map((span) => (
        <motion.span
          ...
          className="absolute h-1 w-1 rounded-full bg-gradient-to-b from-white to-white/70"
        />
      ))}
    </div>
  );
